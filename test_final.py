...
print("  ✓ Barre d'évaluation VISIBLE à gauche (x=20)")
print("  ✓ CHECKMATE détecté au lieu de BLUNDER")
print("  ✓ Badges raccourcis (MISTAKE au lieu de INACCURACY)")
print("  ✓ Profondeur Stockfish augmentée à 20")
print()
